...
import com.tcs.jwt.resource.Foo;
...
public class JWTResourceServerLiveTest {
    ...
    private final String authorizeUrlPattern = "http://localhost:8083/auth/realms/tcs/protocol/openid-connect/auth?response_type=code&client_id=fooClient&scope=%s&redirect_uri=" + redirectUrl;
    private final String tokenUrl = "http://localhost:8083/auth/realms/tcs/protocol/openid-connect/token";
    private final String resourceUrl = "http://localhost:8081/security-resource-server-jwt/foos";
    ...
    private String obtainAccessToken(String scopes) {
        ...
        System.out.print("###################### authorizeUrlPattern ### "+authorizeUrlPattern);
        ...
        System.out.print("###################### authorization code ### "+code);
        // get access token
        ...
        response = RestAssured.given()
            .formParams(params)
            .post(tokenUrl);
        System.out.print("###################### access_token ### "+response.jsonPath().getString("access_token"));
